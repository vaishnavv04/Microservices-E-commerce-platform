...
show_help() {
    ...
    echo ""
    echo "Options:"
    echo "  dev           Start databases in Docker and services locally (standard development)"
    echo "  docker        Start EVERYTHING in Docker (full containerized environment)"
    echo "  elk           Start ELK Stack for centralized logging"
